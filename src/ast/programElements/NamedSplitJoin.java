...
public class NamedSplitJoin extends Container
{
    StreamType type;
    String id;
    List<VarDecl> params;
    ...
    public NamedSplitJoin(StreamType type, String id, List<VarDecl> params, Statement0 body)
    {
        this.type = type;
        this.id = id;
        this.params = params;
    ...
    {
        writer.write("public static SplitJoin ");
    ...
    {
        writer.writeLine("SplitJoin " + variable + " = new SplitJoin();");
    }
